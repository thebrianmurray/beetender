    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-amber-50 to-yellow-100">
      <div className="bg-white rounded-2xl shadow-xl p-10 flex flex-col items-center gap-6 max-w-sm w-full mx-4">
        <div className="flex flex-col items-center gap-2">
          ...
          <h1 className="text-2xl font-bold text-amber-900 tracking-tight">Bee Tender</h1>
          <p className="text-sm text-amber-700 text-center">Pollinator survey data management</p>
        </div>
        ...
        <Button
          ...
          className="w-full bg-amber-500 hover:bg-amber-600 text-white font-medium py-5 rounded-xl flex items-center gap-3"
        >
